...
class UniswapV4Dex:
    ...
    def __init__(self, pair_id, quote_token_address='0xdAC17F958D2ee523a2206206994597C13D831ec7', web3=None, base_token_address=None):
        ...
        with open(os.path.join(abi_dir, 'v4_state_view_abi.json')) as f:
        ...
        self.token0 = base_token_address or "0x97693439EA2f0ecdeb9135881E49f354656a911c"  # Default, should be overridden
